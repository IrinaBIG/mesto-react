function PopupWithForm({ name, title, children, isOpen, isClose, buttonText, onSubmit }) {
    ...
    return (
        <div className={`popup ${name} ${isOpen && "popup_is-active"}`} onClick={handleCloseOverlay} >
